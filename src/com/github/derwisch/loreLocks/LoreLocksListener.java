...
public class LoreLocksListener implements Listener {
    ...
    @EventHandler
    public void onClick_Chest(PlayerInteractEvent event) {
    ...
    @EventHandler
    public void onClick_DoorPick(PlayerInteractEvent event) {
    	Player player = event.getPlayer();
    ...
    public void onClick_DoorLock(PlayerInteractEvent event) {
    	Player player = event.getPlayer();
